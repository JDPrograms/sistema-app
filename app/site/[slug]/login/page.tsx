...
export default function SiteLoginPage() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    if (res?.error) {
      ...
      router.push(tab === "admin" ? `/site/${slug}/admin` : `/site/${slug}`);
    }
  }
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
      <div className="bg-white rounded-2xl shadow-xl w-full max-w-md p-8">
        <div className="mb-6">
          ...
          <h1 className="text-2xl font-bold text-gray-900 mt-3">Iniciar sesion</h1>
          <p className="text-gray-500 text-sm mt-1">Acceso al panel de <span className="font-medium">{slug}</span></p>
        </div>
